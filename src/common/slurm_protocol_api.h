...
int slurm_mediate_receive_msg(int fd, slurm_addr_t *orig_addr, 
				  slurm_msg_t *msg, agent_t* agent_receive, 
				  int timeout);
...
List mediate_slurm_send_recv_msgs(const char *nodelist, slurm_msg_t *msg,int timeout);
extern int slurm_init_mediate_msg_engine_port(uint16_t port, char* host);
